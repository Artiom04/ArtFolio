...
namespace ArtFolio.AccessoPagina.Interface
{
	partial class SchermataPubblicaStudenteBoundary
	{
		...
		private void InitializeComponent()
		{
			...
			elencoPaginePubbliche.Location = new Point(3, 225);
			...
			elencoPaginePubbliche.Size = new Size(502, 340);
			...
			// biografia
			// 
			biografia.Location = new Point(12, 139);
			biografia.Name = "biografia";
			biografia.Size = new Size(493, 83);
			biografia.TabIndex = 11;
			biografia.Text = "Biografia";
			biografia.TextAlign = ContentAlignment.MiddleCenter;
			// 
