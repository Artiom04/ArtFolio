...
{
	// filterParams
	private DateTime filterLowerDate = DateTime.Now.AddDays(-5);
	private DateTime filterUpperDate = DateTime.Now.AddDays(2);
	...
	{
        this.filterLowerDate = date[0]; 
        this.filterUpperDate = date[1];
    }
